...
UNTIL FALSE {
	...
	IF is_guidance() {
		...
		SET rollv TO roll_ref.
		
		SET pitchv TO TAEM_pitch_roll_cor(
	...
	update_TAEM_GUI(rollv, pitchv, az_err, tgt_range, alt_err, simstate["surfvel"]:MAG, pitch_ref, is_guidance(), update_reference ).
